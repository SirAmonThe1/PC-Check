Function Protect-Privacy {
    ...
    Write-Output -ForegroundColor DarkGrey "Stopping and disabling Diagnostics Tracking Service"
    #Disabling the Diagnostics Tracking Service
    Stop-Service "DiagTrack"
    Set-Service "DiagTrack" -StartupType Disabled

    Write-Host
    Write-Output -ForegroundColor DarkGrey "Removing CloudStore from registry if it exists"
