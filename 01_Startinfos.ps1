...
# Leistungsindex 
Write-Host -BackgroundColor Blue -ForegroundColor Green "##### --- Leistungsindex erstellen"
Write-Host
...
Write-Host -BackgroundColor Blue -ForegroundColor Green "##### --- Systemwiederherstellung"
Write-Host
...
Write-Host
Write-Host -BackgroundColor Blue -ForegroundColor Green "--- Pruefe PSWindowsUpdate Installation"
Write-Host
