...
# Leistungsindex 
Write-Host -BackgroundColor Blue -ForegroundColor Magenta "##### --- Leistungsindex erstellen"
Write-Host
...
Write-Host -BackgroundColor Blue -ForegroundColor Magenta "##### --- Systemwiederherstellung"
Write-Host
...
Write-Host
Write-Host -BackgroundColor Blue -ForegroundColor Magenta "--- Pruefe PSWindowsUpdate Installation"
Write-Host
